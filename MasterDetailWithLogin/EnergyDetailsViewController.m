...
@interface EnergyDetailsViewController ()

@end

@implementation EnergyDetailsViewController
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    NSString *filePath=[[NSBundle mainBundle]pathForResource:@"energy" ofType:@"html" inDirectory:nil];
    NSLog(@"%@",filePath);
